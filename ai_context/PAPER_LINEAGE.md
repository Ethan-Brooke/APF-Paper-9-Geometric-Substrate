...
- **Version in this repo:** v3.7
- **File in this repo:** `Paper_9_Geometric_Substrate_Cost_Structure_v3.7.tex` + `.pdf`
- **Page count:** 61 pp
...
- **Concept DOI:** 10.5281/zenodo.20041675
...
- **v3.7** (current): see the main paper's changelog section for details.
...
**vv3.7 supersedes all earlier versions** for current reference. If citing for strict reproducibility of work published before this version, cite the version DOI from the specific Zenodo deposit the earlier work used.
...
*Generated by `create-repo`. The `- **v3.7** (current): see the main paper's changelog section for details.
